...
import { addCoins, ACHIEVEMENTS, certificates, evaluateStickers, exportSave, fileCert, importSave, load, migrate, recordAccuracy, recordBossWin, recordCert, recordMemory, recordSprint, recordTopic, recordTraining, reset, save, saveVersionOf, stickersFor, touchStreak, CERT_CAP, SAVE_VERSION, SPRINT_STICKER_SCORE, STICKER_IDS, STICKER_COST, TOPICS_STARRED_GOAL, type StoredCert } from '../../src/storage';
