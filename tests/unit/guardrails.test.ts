...
describe('.claude/settings.json layer-0 hooks: executed against synthesized stdin (#217 review)', () => {
  ...
  const canonHookCmd = mcpEntry.hooks[4].command;
