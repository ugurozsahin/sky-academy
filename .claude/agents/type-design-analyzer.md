...
color: pink
---
<!-- vendored: anthropics/claude-plugins-official plugins/pr-review-toolkit/agents/type-design-analyzer.md @ 3b600518a637 — Apache-2.0. Copied verbatim for #180; do not edit the body. A project-specific adjustment belongs in a project skill that refers to this one. -->
