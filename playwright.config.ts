...
export default defineConfig({
  ...
  projects: [
    ...
    // is the #116 rail's shape for a non-tablet project; with its own `testDir` it has nothing to ignore.
    { name: 'sketchbook', testDir: 'tests/sketch', testIgnore: /viewport\.spec\.ts/, use: { defaultBrowserType: 'chromium', viewport: { width: 600, height: 600 }, deviceScaleFactor: 2 } },
  ],
});
