...
4. **Its issue has an unticked "Owner action" that gates a visual** (art, skins, decorations, anything the owner must approve from a screenshot). Post the screenshots on the PR and leave it open for him. Stop reviewing after ~15 minutes and go to STEP 3. (STEP 0 still applies here and in every step below: the moment anything mentions a usage limit, rate limit, overage or quota, stop and record it — that trigger almost always fires down here, an hour after you read the rule.)
